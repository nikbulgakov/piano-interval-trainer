...
4. Проверить lint в GitHub Actions.
5. Провести ручную приёмку локально в настольном Chrome или Edge, включая реальную MIDI-клавиатуру, если изменение затрагивает MIDI или тренировку.
