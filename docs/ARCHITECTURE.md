...
Web Audio также изолируется от доменной логики. Звук реагирует на нормализованные MIDI Note On/Off события и пользовательские настройки, но не влияет на генерацию заданий, проверку ответа или счётчики.
